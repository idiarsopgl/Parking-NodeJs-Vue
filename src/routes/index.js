...
const TheVehicleEntry = () =>
  import("../views/vehicle-entry/TheVehicleEntry.vue");
const TheVehicleExit = () => import("../views/vehicle-exit/TheVehicleExit.vue");
const TheParkingManagement = () =>
  import("../views/parking-management/TheParkingManagement.vue");
const TheReports = () => import("../views/reports/TheReports.vue");
const TheAnprSettings = () =>
  import("../views/anpr-settings/TheAnprSettings.vue");
const TheUserManagement = () =>
  import("../views/user-management/TheUserManagement.vue");
const TheTariffSettings = () =>
  import("../views/tariff-settings/TheTariffSettings.vue");
